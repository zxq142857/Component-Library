  ...
  <div class="dialog-model">
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide" @click="openDialog(1)">Dialog Model 1 -- 普通对话框</div>
            <div class="swiper-slide" @click="openDialog(2)">Dialog Model 2 -- 确认弹窗</div>
            <div class="swiper-slide" @click="openDialog(3)">Dialog Model 3 -- 提示弹窗</div>
        </div>
    ...
    <CodeBox>
        <template v-slot:codeIntro>
          <div class="description">
              <p>
                  <code>mode</code>属性设置模态框的模型样式，值为'common', 'comfirm', 'tips'，默认为'common'。<br/>
                  ...
                  <code>comfirmHandle</code>事件，当mode 为'common', 'comfirm'，点击确认按钮的回调。<br/>
...
<style lang="less" scoped>
    ...
    .swiper-container {
        ...
        .swiper-slide {
            ...
            line-height: 300px;
            color: rgb(55, 1, 251);
            background-color: rgba(0,251,251,.5);
            border-radius: 5px;
        } 
    }
